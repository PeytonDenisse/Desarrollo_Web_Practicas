...
function cargarProyectos() {
    const listaProyectos = document.getElementById('listaTareas');
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-3">
            <div class="card bg-dark text-white">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-primary me-2" onclick="verProyecto(${indice})">Ver</button>
                    </div>
                </div>
            </div>
        </div>
